...
import (
	...
	"github.com/luc-git/go-ios/ios/mobileactivation"

	"github.com/luc-git/go-ios/ios/afc"

	"github.com/luc-git/go-ios/ios/crashreport"
	"github.com/luc-git/go-ios/ios/testmanagerd"

	"github.com/luc-git/go-ios/ios/debugserver"
	"github.com/luc-git/go-ios/ios/imagemounter"
	"github.com/luc-git/go-ios/ios/zipconduit"

	"github.com/luc-git/go-ios/ios/simlocation"

	"github.com/docopt/docopt-go"
	"github.com/luc-git/go-ios/ios"
	"github.com/luc-git/go-ios/ios/accessibility"
	"github.com/luc-git/go-ios/ios/debugproxy"
	"github.com/luc-git/go-ios/ios/diagnostics"
	"github.com/luc-git/go-ios/ios/forward"
	"github.com/luc-git/go-ios/ios/installationproxy"
	"github.com/luc-git/go-ios/ios/instruments"
	"github.com/luc-git/go-ios/ios/mcinstall"
	"github.com/luc-git/go-ios/ios/notificationproxy"
	"github.com/luc-git/go-ios/ios/pcap"
	"github.com/luc-git/go-ios/ios/screenshotr"
	syslog "github.com/luc-git/go-ios/ios/syslog"
